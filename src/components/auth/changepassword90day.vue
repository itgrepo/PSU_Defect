    ...
    <v-dialog persistent v-model="Changepass" width="600">
      <div>
        <v-flex xs12>
          ...
          <v-card-text class="textPadTop title">Password Expire Alert</v-card-text>
          <p class="textPadTop subheading textBlack">Request changing password every 3 months for your security.</p>
