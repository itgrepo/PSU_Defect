...
export default {
    ...
    return {
      ...
      newpasswordRules: [
        ...
        v =>
          ...
          "Require at least 8 characters of capital letter, small letter and number (EXP:Xxxxxxxxx1)"
      ],
      repassword: "",
      repasswordRules: [
        v => !!v || "Password is required",
  ...
  methods: {
    ...
    resetPassword() {
      ...
      this.axios
        .post(process.env.VUE_APP_API_BACKEND + "/resetPassword", {
          password: passwordEncrypt,
          currentPassword: currentPasswordEncrypt,
          user_id: Encode.encode(this.data.user_id),
        ...
        .then(response => {
          ...
          if (response.data.status === "success") {
            ...
            this.$cookies.set(
              "information",
              Encode.encode(JSON.stringify(this.data)),
              null,
              "/",
              process.env.DOMAIN
            );
            ...
            this.$swal(
              "New password must not be the same as current and previous 2 passwords.",
              "",
              "warning"
            );
          } else {
