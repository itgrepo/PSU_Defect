<template>
  <v-app class="loginpage" color="">
    <v-content color="white">
      <!-- <v-toolbar>
      <v-btn @click="changeLanguage('th')">เปลี่ยนเป็นภาษาไทย</v-btn>
      <v-btn @click="changeLanguage('en')">Switch to English</v-btn>
    </v-toolbar> -->
      <v-container fluid fill-height>
        <v-layout align-center justify-center wrap>
          <!-- ฝั่งทางซ้าย: ฟอร์ม Login -->
          <v-flex xs12 sm8 lg7 class="pr-12">
            ...
            >
              ...
              <v-row
                justify="center"
                class="align-center text--center justify-center mb-4"
              >
                <v-btn color="primary" @click="redirectToOpenIDProvider" solo large>
