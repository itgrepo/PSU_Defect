<template lang="html">
  ...
  <div id="Number_of_Broadband_Subscribers"></div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("Number_of_Broadband_Subscribers", am4charts.XYChart);
      chart.dataSource.load();
      chart.responsive.enabled = true;
      chart.paddingBottom = 10;

      let title1 = chart.titles.create();
      title1.text = "(Unit: Subscriber)";
      title1.align = "center";
      title1.fontSize = 12;
      ...
      title.text = "Number of Broadband Subscribers";
      title.align = "center";
      title.fontSize = 12;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWT003001")
        .then(response => {
        ...
        .then(status => {
          ...
          //                         </tr>
          //                         </table>`;
          series1.stroke = am4core.color("#FF8F00");
          //
...
<style lang="css" scoped>
  #Number_of_Broadband_Subscribers {
    width: 100%;
    height: 100%;
  }
</style>