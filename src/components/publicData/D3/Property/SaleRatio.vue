...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("saleratio", am4charts.XYChart);
      // chart.numberFormatter.numberFormat = "#.#'%'";

      // title
      let title = chart.titles.create();
      title.text = "Total Value of Units Sold to Total Supply (%)";
      title.align = "center";
      title.fontSize = 12;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWP002401")
        .then(response => {
          ...
          json.forEach(element => {
            ...
            if (element.HouseType === "Condominiums" && element.Region === "Bangkok") {
              JsonDataCon["Period"] = element.year + " " + element.Period;
              JsonDataCon["Condominiums Bangkok"] = +element.aggvalue;

            } else if (element.HouseType === "Condominiums" && element.Region === "Vicinity") {
              JsonDataCon["Period"] = element.year + " " + element.Period;
              JsonDataCon["Condominiums Vicinity"] = +element.aggvalue;
            } else if (element.HouseType === "Housing estate " && element.Region === "Bangkok") {
              JsonDataCon["Period"] = element.year + " " + element.Period;
              JsonDataCon["Housing estate Bangkok"] = +element.aggvalue;
            } else if (element.HouseType === "Housing estate " && element.Region === "Vicinity") {
              JsonDataCon["Period"] = element.year + " " + element.Period;
              JsonDataCon["Housing estate Vicinity"] = +element.aggvalue;
            }
        ...
        .then(status => {
          ...
          series1.dataFields.valueY = "Condominiums Bangkok";
          series1.dataFields.categoryX = "Period";
          series1.name = "Condominiums (BKK)";
          series1.strokeWidth = 2;
          // series1.minBulletDistance = 1;
          series1.tensionX = 0.7;
          series1.stroke = am4core.color("#F9AA00");
          ...
          series2.dataFields.valueY = "Condominiums Vicinity";
          series2.dataFields.categoryX = "Period";
          series2.name = "Condominiums (Vicinity)";
          series2.strokeWidth = 2;
          series2.tensionX = 0.7;
          // series2.minBulletDistance = 1;
          series2.stroke = am4core.color("#00487A");
          ...
          series3.dataFields.valueY = "Housing estate Bangkok";
          series3.dataFields.categoryX = "Period";
          series3.name = "Housing estate (BKK)";
          ...
          series3.stroke = am4core.color("#3C9681");
          ...
          series4.dataFields.valueY = "Housing estate Vicinity";
          series4.dataFields.categoryX = "Period";
          series4.name = "Housing estate (Vicinity)";
          series4.strokeWidth = 2;
          series4.tensionX = 0.7;
          // series4.minBulletDistance = 1;
          series4.stroke = am4core.color("#D31D0D");
