...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("hdsi", am4charts.XYChart);
      // title
      let title = chart.titles.create();
      title.text = "Housing Developer's Sentiment Index (HDSI)";
      title.align = "center";
      title.fontSize = 12;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWP002501")
        .then(response => {
          ...
          json.forEach(element => {
            ...
            if (element.Type === "Current Situation Index") {
              JsonDataCon["Period"] = element.Year + " " + element.Quarter;
              JsonDataCon["Current Situation Index"] = +element.Value;
            } else if (element.Type == "Expectations Index (Next 6 Months)") {
              JsonDataCon["Period"] = element.Year + " " + element.Quarter;
              JsonDataCon["Expectations Index (Next 6 Months)"] = element.Value;
            }
            else if (element.Type == "Sale Expectation Index (Next 6 Months)") {
              JsonDataCon["Period"] = element.Year + " " + element.Quarter;
              JsonDataCon["Sale Expectation Index (Next 6 Months)"] = element.Value;
            }
        ...
        .then(status => {
          ...
          series1.dataFields.valueY = "Current Situation Index";
          series1.dataFields.categoryX = "Period";
          series1.name = "Current Situation Index";
          ...
          series2.dataFields.valueY = "Expectations Index (Next 6 Months)";
          series2.dataFields.categoryX = "Period";
          series2.name = "Expectations Index (Next 6 Months)";
          ...
          series3.dataFields.valueY = "Sale Expectation Index (Next 6 Months)";
          series3.dataFields.categoryX = "Period";
          series3.name = "Sale Expectation Index (Next 6 Months)";
