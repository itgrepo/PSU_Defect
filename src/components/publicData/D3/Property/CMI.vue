...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("cmi", am4charts.XYChart);
      // title
      let title = chart.titles.create();
      title.text = "Construction Material Price Index (CMI)";
      title.align = "center";
      title.fontSize = 12;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWP002301")
        .then(response => {
        ...
        .then(status => {
          ...
          series1.stroke = am4core.color("#027DC5");
