...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("ind003", am4charts.XYChart);
      // title
      let title = chart.titles.create();
      title.text = "(Base Year = 2016)";
      title.align = "center";
      title.fontSize = 10;
      ...
      title1.text = "Capacity Utilization (%)";
      title1.align = "center";
      title1.fontSize = 11;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWI000901")
        .then(response => {
          ...
          json.forEach(element => {
            ...
            if (element.Type === "Integrated Index (Seasonally adjusted)") {
              JsonDataCon["Period"] = element.Year + " " + element.Month;
              JsonDataCon["Seasonally adjusted"] = element.Value;
            } else if (element.Type == "Integrated Index (Not seasonally adjusted)") {
              JsonDataCon["Period"] = element.Year + " " + element.Month;
              JsonDataCon["Not seasonally adjusted"] = element.Value;
            }
        ...
        .then(status => {
          ...
          series1.dataFields.valueY = "Seasonally adjusted";
          series1.dataFields.categoryX = "Period";
          series1.name = "Seasonally adjusted";
          series1.strokeWidth = 2;
          series1.tensionX = 0.7;
          series1.stroke = am4core.color("#F9A825");
          ...
          series2.dataFields.valueY = "Not seasonally adjusted";
          series2.dataFields.categoryX = "Period";
          series2.name = "Not seasonally adjusted";
          series2.strokeWidth = 2;
          series2.tensionX = 0.7;
          series2.stroke = am4core.color("#01579B");
