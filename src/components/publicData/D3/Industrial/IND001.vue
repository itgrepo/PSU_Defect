...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("ind001", am4charts.XYChart);
      // title
      ...
      title1.text = "Manufacturing Production Index (Value added Weight)";
      title1.align = "center";
      title1.fontSize = 11;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWI000101")
        .then(response => {
        ...
        .then(status => {
          ...
          series2.stroke = am4core.color("#388E3C");
