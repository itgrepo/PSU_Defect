...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("farmincome", am4charts.XYChart);
      // title
      let title1 = chart.titles.create();
      title1.text = "(Year 2005 = 100)";
      title1.align = "center";
      title1.fontSize = 10;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWB006001")
        .then(response => {
          ...
          json.forEach(element => {
            ...
            JsonDataCon["Value"] = element.Value;
        ...
        .then(status => {
          ...
          series1.name = "Total CMI";
          series1.strokeWidth = 2;
          // series1.minBulletDistance = 1;
          series1.tensionX = 0.7;
          series1.stroke = am4core.color("#034B61");
