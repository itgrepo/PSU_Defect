<template lang="html">
  <div id="ManufactoringProduction"></div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("ManufactoringProduction", am4charts.XYChart);
      // title
      let title = chart.titles.create();
      title.text = "(Production Value Weight, Year 2016 = 100)";
      title.align = "center";
      title.fontSize = 10;
      ...
      title1.text = "Manufacturing Production Index of Food Products and Beverages";
      title1.align = "center";
      title1.fontSize = 12;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWG003301")
        .then(response => {
          ...
          json.forEach(element => {
            ...
            if (element.Type === "Manufacture of food products (TSIC : 10) ") {
              JsonDataCon["Period"] = element.Year + " " + element.Month;
              JsonDataCon["Food products"] = element.Value;
            } else if (element.Type == "Manufacture of beverages (TSIC : 11)") {
              JsonDataCon["Period"] = element.Year + " " + element.Month;
              JsonDataCon["Beverages"] = element.Value;
            }
        ...
        .then(status => {
          ...
          series1.dataFields.valueY = "Food products";
          series1.dataFields.categoryX = "Period";
          series1.name = "Food products";
          series1.strokeWidth = 2;
          series1.tensionX = 0.7;
          series1.stroke = am4core.color("#028C6A");
          ...
          series2.dataFields.valueY = "Beverages";
          series2.dataFields.categoryX = "Period";
          series2.name = "Beverages";
          series2.strokeWidth = 2;
          series2.tensionX = 0.7;
          series2.stroke = am4core.color("#E81E25");
