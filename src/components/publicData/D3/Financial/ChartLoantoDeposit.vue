...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.getDataGraph()
      let chart = am4core.create("chartLoantoDeposit", am4charts.XYChart);
      chart.dataSource.load();
      chart.responsive.enabled = true;
      chart.paddingBottom = 10;

      let title = chart.titles.create();
      title.text = "Loan to Deposit (Excluding Interbank) (%)";
      title.align = "center";
      title.fontSize = 12;
      ...
      this.axios
        .get(process.env.VUE_APP_API_BACKEND + "/datasourceDWB000501")
        .then(response => {
          ...
          json.forEach(element => {
            //่แยกส่วน json
            var jsonData = {};
            if (element.Type3 == "Loans / Deposits and Bill of Exchange Ratio (Excluding Interbank) of Commercial Banks") {
              //แพ็คข้อมูลที่ต้องการ
              jsonData["Period"] = element.Year + " " + element.Month;
              jsonData["L/Dratio"] = +element.Value;
        ...
        .then(status => {
          ...
          series1.dataFields.valueY = "L/Dratio";
          ...
          //                           <td style="font-size: 10px;">{L/Dratio} %</td>
          //                         </tr>
          //                         </table>`;
