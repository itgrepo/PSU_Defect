<template lang="html">
  ...
  <script>
    ...
    export default {
      ...
      mounted() {
        // this.getDataGraph()
        let chart = am4core.create("chartSL002", am4charts.XYChart);
        chart.dataSource.load();
        chart.responsive.enabled = true;
        chart.paddingBottom = 10;
  
        let title = chart.titles.create();
        title.text = "Total Aircraft";
        title.align = "center";
        title.fontSize = 12;
        ...
        this.axios
          .get(process.env.VUE_APP_API_BACKEND + '/datasourceDWC002901')
          .then(response => {
            ...
            json.forEach(element => {
              //่แยกส่วน json
              var jsonData = {};
              if (element.SubType == "Total Aircraft-Inter") {
                //แพ็คข้อมูลที่ต้องการ
                jsonData["Period"] = element.Year + " " + element.Month;
                jsonData["Total Aircraft-Inter"] = +element.Value;
                jsonData["Total Aircraft-Domestic"] = null;
              } else if (element.SubType == "Total Aircraft-Domestic") {
                jsonData["Period"] = element.Year + " " + element.Month;
                jsonData["Total Aircraft-Inter"] = null;
                jsonData["Total Aircraft-Domestic"] = +element.Value;
              }
          ...
          .then(status => {
            ...
            series1.dataFields.valueY = "Total Aircraft-Inter";
            series1.dataFields.categoryX = "Period";
            series1.name = "Total Aircraft-Inter";
            series1.strokeWidth = 2;
            series1.tensionX = 0.7;
            // series1.tooltipText = "Year :{Period}\nTotal Aircraft-Inter:{Total Aircraft-Inter}";
            ...
            /// Total Aircraft-Domestic
            var series2 = chart.series.push(new am4charts.LineSeries());
            series2.dataFields.valueY = "Total Aircraft-Domestic";
            series2.dataFields.categoryX = "Period";
            series2.name = "Total Aircraft-Domestic";
            series2.strokeWidth = 2;
            // series2.strokeDasharray = 4;
            series2.tensionX = 0.7;
            // series2.tooltipText = "Year :{Period}\nTotal Aircraft-Domestic:{Total Aircraft-Domestic}";
            series2.stroke = am4core.color("#FBC02D");
            //
